...
public class GradesServiceImpl implements GradesService {
	...
	@Autowired
	private GivingGradesDto givingGradesDto;
	...
	private GettingGradesDto convertToGradesDto(Grades grades) {
		...
		String classId = schoolClassRepository.findBySchuelerId(grades.getUserId());
		...
		String type = lessonRepository.getType(classId, terminId);
	...
	public List<GradingSchemeDto> getAllGradeSchemesDto(int userId) {
		...
		String classId;
		if (schoolClassRepository.existsById(userId)) {
			classId = schoolClassRepository.findBySchuelerId(userId);
		}
		else {
			FamilyDto familyDto = new FamilyDto();
			familyDto = familyServiceImpl.getFamilyDto(userId);
